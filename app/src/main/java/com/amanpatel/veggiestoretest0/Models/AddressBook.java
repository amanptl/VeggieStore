...
public class AddressBook {
    ...
    public AddressBook(String id, String name, String address, String landmark, String city, String state, String district, String postCode, String email, String phone, String addeddate, String addedip, String modifydate, String modifyip, String isreg, String cid, String mobiledefault, String mobileTitle) {
        this.id = id;
        this.Name = name;
